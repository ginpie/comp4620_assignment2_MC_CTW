...
# As the agent's observations are uninformative, the observation is defined as Not Available.
oned_maze_observation_enum = util.enum('oNA')
...
oNA = oned_maze_observation_enum.oNA
